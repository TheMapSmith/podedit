# Requirements Archive: v3.0 UX & Preview Enhancements
...
- [x] **NAV-05**: Preview playback automatically skips all marked cut regions
- [x] **NAV-06**: Preview playback seeks past cut region when user clicks word inside cut
- [x] **NAV-07**: Preview playback handles overlapping or adjacent cuts correctly
- [x] **NAV-08**: Preview mode shows visual indicator (status text or badge)
...
**Shipped:** 18 of 18 v3.0 requirements (100%)
