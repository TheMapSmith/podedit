...
must_haves:
  truths:
    - "Cut regions persist in memory during session"
    - "Each cut region is independently identifiable"
    - "Incomplete cut regions (start only) are tracked separately from complete ones"
  artifacts:
