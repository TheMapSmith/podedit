...
8. Press Enter in an input - change is applied
9. Edit an input, press Escape - reverts to previous value
  </verify>
  <done>Cut list has editable timestamp inputs with keyboard support (Enter to commit, Escape to revert) that validate and update cut regions on change</done>
</task>
